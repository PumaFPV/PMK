...
Func srTask = {0, 0, 0, 0, 0, 5000, 0, 0};  //200Hz Limited for debouonce reason
Func espnowTask = {0, 0, 0, 0, 0, 50000, 0, 0};
...
bool ledSleep = 0;
unsigned long ledSleepDelay = 5 * 60 * SECONDS_TO_MILLIS; //5 min
//--------------------------------------------------SideModule
